...
<p>Please read these terms and conditions carefully before using Our Service (beta).</p>
...
<ul>
  ...
  <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>  <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <a href="https://www.chino-js.com/"> CJS Inc.</a>, KRP9 609, 91, Chuudouji Awata-cho, Shimogyo-ku, Kyoto.</li>
  <li><strong>Content</strong> refers to content such as text, images, or other information that can be posted, uploaded, linked to or otherwise made available by You, regardless of the form of that content.</li>  <li><strong>Country</strong> refers to: Japan</li>
  ...
  <li><strong>Website</strong> refers to SciGen.Report, accessible from scigen.report (currently in Beta version)</li>  <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
</ul>
...
<p>For security reasons, the Service uses reCAPTCHA and the Google
...
<p>Our Service allows You to post Content. You are responsible for the Content that You post to the Service, including its accuracy, legality, reliability, and appropriateness.</p>
<p>By posting Content to the Service, You grant Us the right and license to use, format, publicly perform, publicly display, reproduce, and distribute such Content on and through the Service. You retain any and all of Your rights to any Content You submit, post or display on or through the Service and You are responsible for protecting those rights. You agree that this license includes the right for Us to make Your Content available to other users of the Service, who may also use Your Content subject to these Terms.</p>
<p>You represent and warrant that: (i) the Content is Yours (You own it) or You have the right to use it and grant Us the rights and license as provided in these Terms, and (ii) the posting of Your Content on or through the Service does not violate the privacy rights, publicity rights, copyrights, contract rights or any other rights of any person.</p>

<h2>Code of Conduct</h2>
<p>You must abide to ethical and polite conduct to keep collegial environment in all entries filled by You in this Service.</p>
<li>You shall expose Your reproduction results objectively and avoid biased comments;</li>
<li>You MUST avoid offending the authors of any paper You try to reproduce;</li>
<li>You MUST NOT create user accounts that may be deemed offensive, including impersonation and other ilegit usages;</li>
<li>You MUST NOT make derogatory or defamatory statements of any sort.</li>
...
<p>You can contact our copyright agent via email at contact@scigen.report.</p>
...
<p>The Service and its original content (excluding Content provided by You or other users), features and functionality are the exclusive property of the Company and its licensors.</p>
...
<p>While the Company shall try to provide a safe and secure Service, We cannot provide warranty for a fail-proof system. Without limiting the foregoing, neither the Company nor any of the company's provider makes any representation or warranty of any kind, express or implied: (i) as to the operation or availability of the Service, or the information, content, and materials or products included thereon; (ii) that the Service will be uninterrupted or error-free; (iii) as to the accuracy, reliability, or currency of any information or content provided through the Service; or (iv) that the Service, its servers, the content, or e-mails sent from or on behalf of the Company are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful components.</p>
<p>Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable statutory rights of a consumer, so some or all of the above exclusions and limitations may not apply to You. But in such a case the exclusions and limitations set forth in this section shall be applied to the greatest extent enforceable under applicable law.</p>

<h1>Governing Law</h1>
<p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Website may also be subject to other local, state, national, or international laws.</p>
...
<ul>
<li>By email at: <a href="<?=BASE_URL . 'contact'?>"><?=BASE_URL . 'contact'?></a> </li>
	</ul>
